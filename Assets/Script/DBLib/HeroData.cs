...
namespace DBLib
{
    ...
    public class HeroData
    {
       ...
       /// </summary>
       static HeroData() {
           create(1, "a", 100, 20, 500, 300, 5, 2, 30, 10, 1, 0.5f, 200,200, 1, 2, 3, 4);
           create(2, "b", 100, 20, 500, 300, 5, 2, 30, 10, 1, 0.5f, 200, 200, 1, 2, 3, 4);
           create(3, "c", 100, 20, 500, 300, 5, 2, 30, 10, 1, 0.5f, 200, 200, 6, 2, 3, 4);
           create(4, "d", 100, 20, 500, 300, 5, 2, 30, 10, 1, 0.5f, 200, 200, 3, 2, 3, 4);
       }
       /// <summary>
       /// 创建模型并添加进字典
       /// </summary>
    ...
    //unitAggressivity, unitArmor, unitMoveSpeed, unitLiDao, unitShenfa, unitYuanqi;
